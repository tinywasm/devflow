...
func TestBadgeMarkdown_Default(t *testing.T) {
	...
	want := `<a href="docs/img/custom.svg"><img src="docs/img/custom.svg" alt="Project Badges" title="Generated by devflow from ` + devflow.DevFlowRepository + `"></a>`
	got := h.BadgeMarkdown()
	if got != want {
...
func TestBadgeMarkdown_DefaultHandlerValue(t *testing.T) {
	...
	want := `<a href="docs/img/badges.svg"><img src="docs/img/badges.svg" alt="Project Badges" title="Generated by devflow from ` + devflow.DevFlowRepository + `"></a>`
	got := h.BadgeMarkdown()
	if got != want {
		t.Fatalf("unexpected markdown:\n got: %s\nwant: %s", got, want)
	}
...
func TestBuildBadges_SectionArgsOrder(t *testing.T) {
	...
	h := devflow.NewBadges("output_svgfile:"+out, "readmefile:MYREADME.md", "License:MIT:#007acc")
	if h == nil {
		t.Fatal("NewBadges returned nil")
	}
	if err := h.Err(); err != nil {
